...
public class AdaptadorCuotasPendientes extends RecyclerView.Adapter<AdaptadorCuotasPendientes.ViewHolder> {

    private final Context context;
    private final List<CuotaPendiente> items;

    public AdaptadorCuotasPendientes(List<CuotaPendiente> items,Context context) {
        this.items = items;
    ...
    @Override
    public AdaptadorCuotasPendientes.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Log.e("Este es el valor","Estoy aca");
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_lista_cuotas_pendientes, parent, false);
        return new AdaptadorCuotasPendientes.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(AdaptadorCuotasPendientes.ViewHolder holder, int position) {
