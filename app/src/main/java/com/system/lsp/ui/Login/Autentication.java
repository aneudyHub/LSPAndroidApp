                ...
                if (UWeb.hayConexion(Autentication.this)) {
                    ...
                    if (!cod1.isEmpty()&&!cod0.isEmpty()) {
                        ...
                        try {
                            ...
                            Log.e("VALOR IMEI", obtenerImei());

                            checkLogin(obtenerImei(), codigo);
                ...
                try {
                   ...
                   /* if (status == 200) {*/
                       ...
                       // session.setLogin(true);
                        ...
                        String nombreCompania = jObj.getString("nombre");
                        UPreferencias.guardarNombreCompania(Autentication.this,nombreCompania);
