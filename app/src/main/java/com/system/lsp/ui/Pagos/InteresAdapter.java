...
public class InteresAdapter extends RecyclerView.Adapter<InteresAdapter.CuotaViewHolder>{
    ...
    public void onBindViewHolder(CuotaViewHolder holder, int position) {
        ...
        double total = ( interes + valorMora) - (abonado);
        ...
        holder.cuota_monto.setText(precision.format(interes));
