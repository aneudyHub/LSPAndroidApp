...
public class UPreferencias {
    ...
    private static final String PREFERENCIA_URL_APP = "preferencia.connection";
    ...
    private static final String PREFERENCIA_USER_NOMBRE_COMPANIA = "preferencia.nombre_compania";

    private static final String PREFERENCIA_URL_FOTO = "preferencia.url_foto";
    ...
    public static void guardaUrlAPP(Context contexto, String connection) {
        SharedPreferences sp = getDefaultSharedPreferences(contexto);
        sp.edit().putString(PREFERENCIA_URL_APP, connection).apply();
    }
    ...
    public static String obtenerUrlAPP(Context contexto) {
        return getDefaultSharedPreferences(contexto).getString(PREFERENCIA_URL_APP, null);
    }


    public static void guardarUrlFoto(Context contexto, String claveApi) {
        SharedPreferences sp = getDefaultSharedPreferences(contexto);
        sp.edit().putString(PREFERENCIA_URL_FOTO, claveApi).apply();
    }



    public static String obtenerUrlFoto(Context contexto) {
        return getDefaultSharedPreferences(contexto).getString(PREFERENCIA_URL_FOTO, null);
    }



    public static void guardarNombreCompania(Context contexto, String claveApi) {
        SharedPreferences sp = getDefaultSharedPreferences(contexto);
        sp.edit().putString(PREFERENCIA_USER_NOMBRE_COMPANIA, claveApi).apply();
    }



    public static String obtenerNombreCompania(Context contexto) {
        return getDefaultSharedPreferences(contexto).getString(PREFERENCIA_USER_NOMBRE_COMPANIA, null);
    }
